...
import DataPagination from "./TablePagination";
...
function DataTable({
  ...
  return (
    <div
      className={`bg-white border dark:bg-dark-bg shadow-sm  px-5 py-8 rounded-sm w-[100%] mx-auto lg:w-[80%] lg:ml-36 mb-10 ${divStyles}`}
    >
            ...
            {data.length !== 0 ? (
              ...
              <tr className="">
                <td colSpan={columns.length} className=" ">
                  <div className="mt-6 bg-red-100 border-red-400 text-red-700  text-center text-xl borderpx-4 py-3 rounded relative my-5">
                    {"No data currently"}
                  </div>
                </td>
              </tr>
